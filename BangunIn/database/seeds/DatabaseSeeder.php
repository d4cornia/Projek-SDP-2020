...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('mandors')->insert([
            ['kode_mandor'=>'100001','kode_kontraktor'=>'100001','nama_mandor'=>'monica','no_hp_mandor'=>'082853714156','username_mandor'=>'monica','email_mandor'=>'monica@gmail.com','password_mandor'=>'monica']
        ]);
